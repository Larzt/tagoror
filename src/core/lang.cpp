...
const QHash<QString, QString> &table() {
    static const QHash<QString, QString> t = {
        ...
        {"Anterior", "Previous"},
        {"Siguiente", "Next"},
        {"Nuevo evento o tarea", "New event or task"},
        {"Editar", "Edit"},
        ...
        {"Avisar 10 min antes", "Alert 10 min before"},
        {"Descripción", "Description"},
        {"Eliminar", "Delete"},
        {"Guardar", "Save"},
        {"La fecha tiene que ser dd/mm/aaaa.", "The date has to be dd/mm/yyyy."},
        {"La hora de inicio tiene que ser HH:mm.", "The start time has to be HH:mm."},
        {"El fin tiene que ser una hora posterior al inicio.", "The end has to be later than the start."},
        {"TAREAS DE HOY", "TODAY'S TASKS"},
        {"Sin tareas para hoy.", "No tasks for today."},
        {"Día libre", "Free day"},
        {"Pulsa en una hora para añadir algo", "Click an hour to add something"},
        {"+%1 más", "+%1 more"},
        {"Cumple de %1", "%1's birthday"},
        {"%1 EVENTOS", "%1 EVENTS"},
        ...
        {"en marcha", "running"},
        {"en pausa", "paused"},
        {"tiempo cumplido", "time's up"},
        {"guardado · %1", "saved · %1"},
        {"%1 · tiempo cumplido", "%1 · time's up"},
        {"(y %1 más)", "(and %1 more)"},
        {"Abrir en grande", "Open large"},
        {"Iniciar", "Start"},
        {"Pausar", "Pause"},
        {"Reiniciar", "Reset"},
        {"Cerrar", "Close"},
        {"NUEVO TEMPORIZADOR", "NEW TIMER"},
        {"h", "h"},
        {"min", "min"},
        {"seg", "sec"},
        {"Crear", "Create"},
        ...
        {"Sin conectar · las copias se quedan en este equipo", "Not connected · copies stay on this computer"},
        {"Conectar", "Connect"},
        {"Autoriza el acceso en el navegador…", "Allow access in your browser…"},
        {"subiendo…", "uploading…"},
        {"Subir ahora", "Upload now"},
        {"Reintentar", "Retry"},
        {"Conectado", "Connected"},
        {"subido %1", "uploaded %1"},
        {"sin subir todavía", "nothing uploaded yet"},
        {"Desconectar", "Disconnect"},
        {"No se pudo abrir un puerto local para la autorización.", "Could not open a local port for the authorization."},
        {"No se completó la autorización a tiempo.", "The authorization was not completed in time."},
        {"Respuesta inesperada. Vuelve a Tagoror e inténtalo otra vez.", "Unexpected response. Go back to Tagoror and try again."},
        {"No se ha dado acceso. Puedes cerrar esta pestaña.", "Access was not granted. You can close this tab."},
        {"La autorización se canceló en el navegador.", "The authorization was cancelled in the browser."},
        {"Listo: Tagoror ya puede guardar una copia en tu Drive. Puedes cerrar esta pestaña.", "Done: Tagoror can now keep a copy in your Drive. You can close this tab."},
        {"Google no aceptó la autorización (%1).", "Google did not accept the authorization (%1)."},
        {"Google ha retirado el acceso. Vuelve a conectar la cuenta.", "Google has revoked access. Connect the account again."},
        {"Sin conexión con Google Drive.", "No connection to Google Drive."},
        ...
        {"sincronizado %1", "synced %1"},
        {"sin sincronizar todavía", "not synced yet"},
        {"Listo: Tagoror ya puede sincronizar con tu Drive. Puedes cerrar esta pestaña.", "Done: Tagoror can now sync with your Drive. You can close this tab."},
        {"La carpeta de notas no está disponible.", "The notes folder is not available."},
